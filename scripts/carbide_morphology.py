...
parser.add_argument('--model', type=str, default='Unet', choices=['Unet', 'Segformer', 'MatSegNet'])
...
plot_comparison_figure(bain_area_percentage_list, mar_area_percentage_list, bainite_k_list, martensite_k_list, ylabel_a='Carbide Percentage', ylabel_b='k',save_path=os.path.join(images_saved_dir,"Percentage_and_orientation_percentage.png"))
...
write_percentage_orientation_to_file(os.path.join(images_saved_dir,f"Percentage_Orientation_{args.model}.csv"),data_to_write)
